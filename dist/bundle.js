...
var name = "niu-cli";
var version = "1.0.0";
var description = "命令行脚手架";
var main = "./dist/bundle.js";
var bin = {
	niu: "./bin/www"
};
var scripts = {
	compile: "babel  src/index.ts -o dist/main.js",
	watch: "npm run compile -- --watch",
	xxx: "rollup -c"
};
var repository = {
	type: "git",
	url: "git+https://github.com/all-demo/niu-cli.git"
};
var keywords = [
];
var author = "";
var license = "ISC";
var bugs = {
	url: "https://github.com/all-demo/niu-cli/issues"
};
var homepage = "https://github.com/all-demo/niu-cli#readme";
var devDependencies = {
	"@babel/cli": "^7.13.16",
	"@babel/core": "^7.13.16",
...
commander.program.version(pkg.version).option("-d, --debug", "output extra debugging").option("-s, --small", "small pizza size").option("-p, --pizza-type <type>", "flavour of pizza");
commander.program.command("create [name]").action(function (xxx) {
  console.log(xxx);
});
